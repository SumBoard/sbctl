...
var (
	// ErrSumboardDir is returned anytime an there is an issue in accessing the paths.Sumboard directory.
	ErrSumboardDir = &LocalError{
		msg: "sumboard directory is inaccessible",
		help: `The ~/.sumboard directory is inaccessible.
...
By default, sbctl will allow access from any hostname or IP, so you might not need the --host flag.`,
	}
