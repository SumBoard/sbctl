...
const (
	airbyteBootloaderPodName = "sumboard-sbctl-sumboard-bootloader"
	airbyteChartName         = "sumboard/sumboard"
	airbyteChartRelease      = "sumboard-sbctl"
	airbyteIngress           = "ingress-sbctl"
	airbyteNamespace         = "sumboard-sbctl"
	airbyteRepoName          = "sumboard"
