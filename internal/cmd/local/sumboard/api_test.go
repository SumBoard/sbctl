...
func TestAirbyte_fetchToken(t *testing.T) {
	...
	token := "token-test"
	sumboard := New(host, clientID, clientSecret, WithHTTPClient(mockHTTP))
	...
	t.Run("happy path", func(t *testing.T) {
		...
		tokenActual, err := sumboard.fetchToken(ctx)
		if err != nil {
...
func TestAirbyte_GetOrgEmail(t *testing.T) {
	mockHTTP := &mockHTTPClient{}
	token := Token("token")
	sumboard := New(host, clientID, clientSecret, WithHTTPClient(mockHTTP), WithToken(token))
	ctx := context.Background()
	...
	t.Run("happy path", func(t *testing.T) {
		...
		emailActual, err := sumboard.GetOrgEmail(ctx)
		if err != nil {
	...
	t.Run("error", func(t *testing.T) {
		...
		_, err := sumboard.GetOrgEmail(ctx)
		if d := cmp.Diff(err, errTest, cmpopts.EquateErrors()); d != "" {
...
func TestAirbyte_SetOrgEmail(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		...
		if err := sumboard.SetOrgEmail(ctx, email); err != nil {
	...
	t.Run("error", func(t *testing.T) {
		...
		err := sumboard.SetOrgEmail(ctx, email)
		if d := cmp.Diff(err, errTest, cmpopts.EquateErrors()); d != "" {
			t.Errorf("unexpected error (-want +got):\n%s", d)
		}
	})
