...
const (
	...
	Welcome = `Thanks for using Sumboard!
Anonymous usage reporting is currently enabled. For more information, please see https://docs.sumboard.com/telemetry`
)
...
var ConfigFile = filepath.Join(".sumboard", "analytics.yml")
...
// between this code and PySumboard
...
const header = `# This file is used by Sumboard to track anonymous usage statistics.
# For more information or to opt out, please see
# - https://docs.sumboard.com/operator-guides/telemetry
`
