...
var (
	...
	DefaultProvider = Provider{
		Name:        Kind,
		ClusterName: "sumboard-sbctl",
		Context:     "kind-sumboard-sbctl",
	...
	TestProvider = Provider{
		Name:        Test,
		ClusterName: "test-sumboard-sbctl",
		Context:     "test-sumboard-sbctl",
		Kubeconfig:  filepath.Join(os.TempDir(), "sbctl", paths.FileKubeconfig),
	}
)
