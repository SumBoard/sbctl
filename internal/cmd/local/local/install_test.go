...
import (
	...
	"github.com/SumBoard/sbctl/internal/cmd/local/k8s/k8stest"
...
const portTest = 9999
const testAirbyteChartLoc = "https://airbytehq.github.io/helm-charts/sumboard-1.2.3.tgz"
	...
	helm := mockHelmClient{
		...
		getChart: func(name string, _ *action.ChartPathOptions) (*chart.Chart, string, error) {
			...
			case name == testAirbyteChartLoc:
				return &chart.Chart{Metadata: &chart.Metadata{Version: "test.sumboard.version"}}, "", nil
